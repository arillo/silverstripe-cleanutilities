...
/**
 * Date selector field using jquery.ui.datepicker.
 *
 * @package cleanutilities
 * @subpackage forms
 */
class DateDropdownField extends TextField {
	// TODO extend drom TextField copy whole datefield class and create custom functions
	function Type() {return strtolower(ereg_replace('Field$','','Date'));}
	/**
	 * @var array
	 */
	...
	function FieldHolder() {
		...
		$d = Object::create('DateDropdownField_View_JQuery', $this);
		$d->onBeforeRender();
	...
	function performReadonlyTransformation() {
		$field = new DateDropdownField_Disabled($this->name, $this->title, $this->dataValue());
...
class DateDropdownField_Disabled extends DateField {
...
class DateDropdownField_View_JQuery {
